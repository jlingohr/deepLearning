...
import numpy as np
from .functions import relu_forward, relu_backward
try:
...
def conv_relu_forward_fast(x, w, b, conv_param):
    """
...
def conv_relu_pool_forward_fast(x, w, b, conv_param, pool_param):
    """
